[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / WorkOrdersServicePaginationReq
...
▸ `Static` **fromBinary**(`bytes`, `options?`): [`WorkOrdersServicePaginationReq`](WorkOrdersServicePaginationReq.md)
