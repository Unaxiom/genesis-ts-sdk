[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / SkillsParamsServicePaginationReq
...
▸ `Static` **fromBinary**(`bytes`, `options?`): [`SkillsParamsServicePaginationReq`](SkillsParamsServicePaginationReq.md)
