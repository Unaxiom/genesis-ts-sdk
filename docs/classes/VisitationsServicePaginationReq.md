[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / VisitationsServicePaginationReq
...
▸ `Static` **fromBinary**(`bytes`, `options?`): [`VisitationsServicePaginationReq`](VisitationsServicePaginationReq.md)
