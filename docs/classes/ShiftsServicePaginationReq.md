[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / ShiftsServicePaginationReq
...
▸ `Static` **fromBinary**(`bytes`, `options?`): [`ShiftsServicePaginationReq`](ShiftsServicePaginationReq.md)
