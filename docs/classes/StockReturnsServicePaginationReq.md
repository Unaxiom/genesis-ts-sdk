[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / StockReturnsServicePaginationReq
...
▸ `Static` **fromBinary**(`bytes`, `options?`): [`StockReturnsServicePaginationReq`](StockReturnsServicePaginationReq.md)
