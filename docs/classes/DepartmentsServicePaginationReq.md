[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / DepartmentsServicePaginationReq
...
from message Genesis.DepartmentsServicePaginationReq
...
• **new DepartmentsServicePaginationReq**(`data?`)
...
[src/departments_pb.ts:502](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L502)
...
[src/departments_pb.ts:472](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L472)
...
[src/departments_pb.ts:465](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L465)
...
[src/departments_pb.ts:479](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L479)
...
[src/departments_pb.ts:493](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L493)
...
[src/departments_pb.ts:486](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L486)
...
[src/departments_pb.ts:500](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L500)
...
[src/departments_pb.ts:509](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L509)
...
[src/departments_pb.ts:507](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L507)
...
[src/departments_pb.ts:508](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L508)
...
[src/departments_pb.ts:530](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L530)

___

### fromBinary

▸ `Static` **fromBinary**(`bytes`, `options?`): [`DepartmentsServicePaginationReq`](DepartmentsServicePaginationReq.md)
...
[src/departments_pb.ts:518](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L518)

___

### fromJson

▸ `Static` **fromJson**(`jsonValue`, `options?`): [`DepartmentsServicePaginationReq`](DepartmentsServicePaginationReq.md)
...
[src/departments_pb.ts:522](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L522)

___

### fromJsonString

▸ `Static` **fromJsonString**(`jsonString`, `options?`): [`DepartmentsServicePaginationReq`](DepartmentsServicePaginationReq.md)
...
[src/departments_pb.ts:526](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/departments_pb.ts#L526)
