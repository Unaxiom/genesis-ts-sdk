[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / TeamsServiceCreateRequest
...
▸ `Static` **fromBinary**(`bytes`, `options?`): [`TeamsServiceCreateRequest`](TeamsServiceCreateRequest.md)
