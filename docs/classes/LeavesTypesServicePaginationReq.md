[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / LeavesTypesServicePaginationReq
...
▸ `Static` **fromBinary**(`bytes`, `options?`): [`LeavesTypesServicePaginationReq`](LeavesTypesServicePaginationReq.md)
