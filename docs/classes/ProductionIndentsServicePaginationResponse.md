[@unaxiom/genesis-sdk](../README.md) / [Exports](../modules.md) / ProductionIndentsServicePaginationResponse
...
from message Genesis.ProductionIndentsServicePaginationResponse
...
• **new ProductionIndentsServicePaginationResponse**(`data?`)
...
[src/production_indents_pb.ts:1065](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1065)
...
[src/production_indents_pb.ts:1042](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1042)
...
[src/production_indents_pb.ts:1049](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1049)
...
from field: repeated Genesis.ProductionIndent payload = 4;

#### Defined in

[src/production_indents_pb.ts:1063](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1063)
...
[src/production_indents_pb.ts:1056](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1056)
...
[src/production_indents_pb.ts:1072](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1072)
...
[src/production_indents_pb.ts:1070](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1070)
...
[src/production_indents_pb.ts:1071](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1071)
...
[src/production_indents_pb.ts:1091](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1091)

___

### fromBinary

▸ `Static` **fromBinary**(`bytes`, `options?`): [`ProductionIndentsServicePaginationResponse`](ProductionIndentsServicePaginationResponse.md)
...
[src/production_indents_pb.ts:1079](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1079)

___

### fromJson

▸ `Static` **fromJson**(`jsonValue`, `options?`): [`ProductionIndentsServicePaginationResponse`](ProductionIndentsServicePaginationResponse.md)
...
[src/production_indents_pb.ts:1083](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1083)

___

### fromJsonString

▸ `Static` **fromJsonString**(`jsonString`, `options?`): [`ProductionIndentsServicePaginationResponse`](ProductionIndentsServicePaginationResponse.md)
...
[src/production_indents_pb.ts:1087](https://github.com/Unaxiom/genesis-ts-sdk/blob/a265138/src/production_indents_pb.ts#L1087)
