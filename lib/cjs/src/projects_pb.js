...
exports.ProjectsServiceSearchAllReq = exports.ProjectsServiceFilterReq = exports.ProjectsServiceEntityPaginationReq = exports.ProjectsServicePaginationResponse = exports.ProjectsServicePaginationReq = exports.ProjectsList = exports.Project = exports.ProjectsServiceUpdateRequest = exports.ProjectsServiceCreateRequest = exports.PROJECT_SORT_KEY = void 0;
...
(function (PROJECT_SORT_KEY) ***REMOVED***
    /**
...
***REMOVED***)(PROJECT_SORT_KEY || (exports.PROJECT_SORT_KEY = PROJECT_SORT_KEY = ***REMOVED******REMOVED***));
// Retrieve enum metadata with: proto3.getEnumType(PROJECT_SORT_KEY)
protobuf_1.proto3.util.setEnumType(PROJECT_SORT_KEY, "Genesis.PROJECT_SORT_KEY", [
 ...
 */
class ProjectsServiceCreateRequest extends protobuf_1.Message ***REMOVED***
...
ProjectsServiceCreateRequest.typeName = "Genesis.ProjectsServiceCreateRequest";
 ...
 */
class ProjectsServiceUpdateRequest extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * Stores any comment that the user might add during this operation
...
ProjectsServiceUpdateRequest.typeName = "Genesis.ProjectsServiceUpdateRequest";
 ...
 */
class Project extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * Stores a globally unique entity UUID. This will be set at the organization level
...
Project.typeName = "Genesis.Project";
 ...
 */
class ProjectsList extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * List of records
...
ProjectsList.typeName = "Genesis.ProjectsList";
 ...
 */
class ProjectsServicePaginationReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
...
ProjectsServicePaginationReq.typeName = "Genesis.ProjectsServicePaginationReq";
ProjectsServicePaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    ***REMOVED*** no: 5, name: "sort_key", kind: "enum", T: protobuf_1.proto3.getEnumType(PROJECT_SORT_KEY) ***REMOVED***,
 ...
 */
class ProjectsServicePaginationResponse extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
...
ProjectsServicePaginationResponse.typeName = "Genesis.ProjectsServicePaginationResponse";
 ...
 */
class ProjectsServiceEntityPaginationReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
***REMOVED***
    static equals(a, b) ***REMOVED***
        return protobuf_1.proto3.util.equals(ProjectsServiceEntityPaginationReq, a, b);
***REMOVED***
***REMOVED***
exports.ProjectsServiceEntityPaginationReq = ProjectsServiceEntityPaginationReq;
ProjectsServiceEntityPaginationReq.runtime = protobuf_1.proto3;
ProjectsServiceEntityPaginationReq.typeName = "Genesis.ProjectsServiceEntityPaginationReq";
ProjectsServiceEntityPaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    ***REMOVED*** no: 1, name: "is_active", kind: "scalar", T: 8 /* ScalarType.BOOL */ ***REMOVED***,
    ***REMOVED*** no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ ***REMOVED***,
    ***REMOVED*** no: 3, name: "offset", kind: "scalar", T: 3 /* ScalarType.INT64 */ ***REMOVED***,
    ***REMOVED*** no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_pb_js_1.SORT_ORDER) ***REMOVED***,
 ...
 */
class ProjectsServiceFilterReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
ProjectsServiceFilterReq.typeName = "Genesis.ProjectsServiceFilterReq";
 ...
 */
class ProjectsServiceSearchAllReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
ProjectsServiceSearchAllReq.typeName = "Genesis.ProjectsServiceSearchAllReq";
