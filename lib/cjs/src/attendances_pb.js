...
AttendancesServiceCreateRequest.typeName = "Genesis.AttendancesServiceCreateRequest";
...
AttendancesServiceUpdateRequest.typeName = "Genesis.AttendancesServiceUpdateRequest";
...
AttendancesServiceImageEntryRequest.typeName = "Genesis.AttendancesServiceImageEntryRequest";
...
AttendancesServiceImageExitRequest.typeName = "Genesis.AttendancesServiceImageExitRequest";
...
Attendance.typeName = "Genesis.Attendance";
...
AttendancesList.typeName = "Genesis.AttendancesList";
...
AttendancesServicePaginationReq.typeName = "Genesis.AttendancesServicePaginationReq";
...
AttendancesServicePaginationResponse.typeName = "Genesis.AttendancesServicePaginationResponse";
...
AttendancesServiceEntityPaginationReq.runtime = protobuf_1.proto3;
AttendancesServiceEntityPaginationReq.typeName = "Genesis.AttendancesServiceEntityPaginationReq";
AttendancesServiceEntityPaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    ***REMOVED*** no: 1, name: "is_active", kind: "scalar", T: 8 /* ScalarType.BOOL */ ***REMOVED***,
    ***REMOVED*** no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ ***REMOVED***,
    ***REMOVED*** no: 3, name: "offset", kind: "scalar", T: 3 /* ScalarType.INT64 */ ***REMOVED***,
    ***REMOVED*** no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_pb_js_1.SORT_ORDER) ***REMOVED***,
...
AttendancesServiceFilterReq.typeName = "Genesis.AttendancesServiceFilterReq";
...
AttendancesServiceSearchAllReq.typeName = "Genesis.AttendancesServiceSearchAllReq";
