...
(function (VISITATION_SORT_KEY) ***REMOVED***
    /**
...
***REMOVED***)(VISITATION_SORT_KEY || (exports.VISITATION_SORT_KEY = VISITATION_SORT_KEY = ***REMOVED******REMOVED***));
 ...
 */
class VisitationsServiceCreateRequest extends protobuf_1.Message ***REMOVED***
...
VisitationsServiceCreateRequest.typeName = "Genesis.VisitationsServiceCreateRequest";
 ...
 */
class VisitationsServiceUpdateRequest extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * Stores any comment that the user might add during this operation
...
VisitationsServiceUpdateRequest.typeName = "Genesis.VisitationsServiceUpdateRequest";
 ...
 */
class VisitationsServiceImageEntryRequest extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * Stores a globally unique entity UUID. This will be set at the organization level
...
VisitationsServiceImageEntryRequest.typeName = "Genesis.VisitationsServiceImageEntryRequest";
 ...
 */
class VisitationsServiceImageExitRequest extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * The ID of the record that needs to be updated
...
VisitationsServiceImageExitRequest.typeName = "Genesis.VisitationsServiceImageExitRequest";
 ...
 */
class Visitation extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * Stores a globally unique entity UUID. This will be set at the organization level
...
Visitation.typeName = "Genesis.Visitation";
 ...
 */
class VisitationsList extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * List of records
...
VisitationsList.typeName = "Genesis.VisitationsList";
 ...
 */
class VisitationsServicePaginationReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
...
VisitationsServicePaginationReq.typeName = "Genesis.VisitationsServicePaginationReq";
VisitationsServicePaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    ***REMOVED*** no: 5, name: "sort_key", kind: "enum", T: protobuf_1.proto3.getEnumType(VISITATION_SORT_KEY) ***REMOVED***,
 ...
 */
class VisitationsServicePaginationResponse extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
...
VisitationsServicePaginationResponse.typeName = "Genesis.VisitationsServicePaginationResponse";
 ...
 */
class VisitationsServiceEntityPaginationReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
VisitationsServiceEntityPaginationReq.runtime = protobuf_1.proto3;
VisitationsServiceEntityPaginationReq.typeName = "Genesis.VisitationsServiceEntityPaginationReq";
VisitationsServiceEntityPaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    ***REMOVED*** no: 1, name: "is_active", kind: "scalar", T: 8 /* ScalarType.BOOL */ ***REMOVED***,
    ***REMOVED*** no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ ***REMOVED***,
    ***REMOVED*** no: 3, name: "offset", kind: "scalar", T: 3 /* ScalarType.INT64 */ ***REMOVED***,
    ***REMOVED*** no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_pb_js_1.SORT_ORDER) ***REMOVED***,
 ...
 */
class VisitationsServiceFilterReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
VisitationsServiceFilterReq.typeName = "Genesis.VisitationsServiceFilterReq";
 ...
 */
class VisitationsServiceSearchAllReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
VisitationsServiceSearchAllReq.typeName = "Genesis.VisitationsServiceSearchAllReq";
