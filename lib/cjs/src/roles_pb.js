...
RolesServiceCreateRequest.typeName = "Genesis.RolesServiceCreateRequest";
...
RolesServiceUpdateRequest.typeName = "Genesis.RolesServiceUpdateRequest";
...
RolesServiceAccessCreateAndUpdateRequest.typeName = "Genesis.RolesServiceAccessCreateAndUpdateRequest";
...
RoleAccess.typeName = "Genesis.RoleAccess";
...
RolesList.typeName = "Genesis.RolesList";
...
RolesServicePaginationReq.typeName = "Genesis.RolesServicePaginationReq";
...
RolesServicePaginationResponse.typeName = "Genesis.RolesServicePaginationResponse";
 ...
 */
class RolesServiceEntityPaginationReq extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
RolesServiceEntityPaginationReq.runtime = protobuf_1.proto3;
RolesServiceEntityPaginationReq.typeName = "Genesis.RolesServiceEntityPaginationReq";
RolesServiceEntityPaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "is_active", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "offset", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_pb_js_1.SORT_ORDER) },
...
RolesServiceFilterReq.typeName = "Genesis.RolesServiceFilterReq";
...
RolesServiceSearchAllReq.typeName = "Genesis.RolesServiceSearchAllReq";
