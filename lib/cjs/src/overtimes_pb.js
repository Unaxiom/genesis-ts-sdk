...
exports.OvertimesServiceSearchAllReq = exports.OvertimesServiceFilterReq = exports.OvertimesServiceEntityPaginationReq = exports.OvertimesServicePaginationResponse = exports.OvertimesServicePaginationReq = exports.OvertimesList = exports.Overtime = exports.OvertimesServiceUpdateRequest = exports.OvertimesServiceCreateRequest = exports.OVERTIME_SORT_KEY = void 0;
...
(function (OVERTIME_SORT_KEY) ***REMOVED***
    /**
...
***REMOVED***)(OVERTIME_SORT_KEY || (exports.OVERTIME_SORT_KEY = OVERTIME_SORT_KEY = ***REMOVED******REMOVED***));
// Retrieve enum metadata with: proto3.getEnumType(OVERTIME_SORT_KEY)
protobuf_1.proto3.util.setEnumType(OVERTIME_SORT_KEY, "Genesis.OVERTIME_SORT_KEY", [
 ...
 */
class OvertimesServiceCreateRequest extends protobuf_1.Message ***REMOVED***
...
OvertimesServiceCreateRequest.typeName = "Genesis.OvertimesServiceCreateRequest";
 ...
 */
class OvertimesServiceUpdateRequest extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * Stores any comment that the user might add during this operation
...
OvertimesServiceUpdateRequest.typeName = "Genesis.OvertimesServiceUpdateRequest";
 ...
 */
class Overtime extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * Stores a globally unique entity UUID. This will be set at the organization level
...
Overtime.typeName = "Genesis.Overtime";
 ...
 */
class OvertimesList extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * List of records
...
OvertimesList.typeName = "Genesis.OvertimesList";
 ...
 */
class OvertimesServicePaginationReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
...
OvertimesServicePaginationReq.typeName = "Genesis.OvertimesServicePaginationReq";
OvertimesServicePaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    ***REMOVED*** no: 5, name: "sort_key", kind: "enum", T: protobuf_1.proto3.getEnumType(OVERTIME_SORT_KEY) ***REMOVED***,
 ...
 */
class OvertimesServicePaginationResponse extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
...
OvertimesServicePaginationResponse.typeName = "Genesis.OvertimesServicePaginationResponse";
 ...
 */
class OvertimesServiceEntityPaginationReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
***REMOVED***
    static equals(a, b) ***REMOVED***
        return protobuf_1.proto3.util.equals(OvertimesServiceEntityPaginationReq, a, b);
***REMOVED***
***REMOVED***
exports.OvertimesServiceEntityPaginationReq = OvertimesServiceEntityPaginationReq;
OvertimesServiceEntityPaginationReq.runtime = protobuf_1.proto3;
OvertimesServiceEntityPaginationReq.typeName = "Genesis.OvertimesServiceEntityPaginationReq";
OvertimesServiceEntityPaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    ***REMOVED*** no: 1, name: "is_active", kind: "scalar", T: 8 /* ScalarType.BOOL */ ***REMOVED***,
    ***REMOVED*** no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ ***REMOVED***,
    ***REMOVED*** no: 3, name: "offset", kind: "scalar", T: 3 /* ScalarType.INT64 */ ***REMOVED***,
    ***REMOVED*** no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_pb_js_1.SORT_ORDER) ***REMOVED***,
 ...
 */
class OvertimesServiceFilterReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
OvertimesServiceFilterReq.typeName = "Genesis.OvertimesServiceFilterReq";
 ...
 */
class OvertimesServiceSearchAllReq extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * If true, then returns only active records. If false, then returns only inactive records
...
OvertimesServiceSearchAllReq.typeName = "Genesis.OvertimesServiceSearchAllReq";
