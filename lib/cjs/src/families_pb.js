 ...
 */
class Family extends protobuf_1.Message ***REMOVED***
...
Family.fields = protobuf_1.proto3.util.newFieldList(() => [
    ...
    ***REMOVED*** no: 27, name: "status", kind: "enum", T: protobuf_1.proto3.getEnumType(base_pb_js_1.STANDARD_LIFECYCLE_STATUS) ***REMOVED***,
 ...
 */
class FamiliesList extends protobuf_1.Message ***REMOVED***
    constructor(data) ***REMOVED***
        super();
        /**
         * List of families
